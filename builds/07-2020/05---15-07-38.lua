...
function generateProfileImgs(playerName)
    local graffitiTextX, graffitiTextY = 588, 265
    addTextArea(120, "", playerName, graffitiTextX, 133, 80, 80, 0x264E57, 0x264E57, 1, true)
    addTextArea(121, "", playerName, graffitiTextX, 234, 80, 80, 0x264E57, 0x264E57, 1, true)
    addTextArea(122, "<p align='center'><font face='"..shop.graffitiFonts[playerStats[playerName].equipment[4]].imgId.."' size='16' color='"..shop.graffitiCol[playerStats[playerName].equipment[2]].imgId.."'>"..string.gsub(playerName, "#%d%d%d%d", "").."</font></p>", playerName, graffitiTextX, graffitiTextY, 80, 50, 0x324650, 0x000000, 0, true)
