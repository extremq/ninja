...
function updateMapName(timeRemaining)
    ...
    local name = currentmapauthor.." <G>-<N> "..currentmapcode.." <G>- "..translate(roomCommunity, "infobarLevel").." "..difficultyMessage.." <G>| <N>"..translate(roomCommunity, "infobarMice").." <J>"..room.uniquePlayers.." <G>| <N>"..minutes..":"..seconds
    -- Append record
