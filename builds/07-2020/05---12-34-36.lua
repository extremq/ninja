...
function stats(playerName, creatorName)
    ...
    body = body.."<textformat tabstops='0,200' font='Verdana'>Title: <V>«Speedy»</V>\t"..translate(playerName, "playtime")..": <V>"..math.floor(seconds/3600).."h "..math.floor(seconds%3600/60).."m "..(seconds%3600%60).."s</V></textformat>\n"
