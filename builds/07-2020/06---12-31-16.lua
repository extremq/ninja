...
modList = {['Extremq#0000'] = true, ['Railysse#0000'] = true, ['Syrius#8114'] = true}
translatorList = {['Extremq#0000'] = true, ['Railysse#0000'] = true, ['Syrius#8114'] = true, ['Jaker#9310'] = true, ['Tocutoeltuco#0000'] = true, ['Osmanyksk123#5925'] = true, ['Poklava#0000']}
...
function generateProfileImgs(playerName, target)
    ...
    if translatorList[playerName] == true then
        currentBadges[#currentBadges + 1] = TRS_BADGE
    end
    if mapperList[playerName] == true then
    ...
    for i=1, #currentBadges do
        putInClearQueue(addImage(currentBadges[i], "&100", badge_x[i], badge_y), "img", playerName)
    end
