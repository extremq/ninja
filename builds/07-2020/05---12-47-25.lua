...
function windowConfig(title, body, playerName, pageId)
    ...
    if pageId:find("profile") ~= nil then
        ...
        addTextArea(16, "<font face='Soopafresh,Verdana' size='30' color='#000000'>"..removeTag(profileName).." <font size='-5'>"..profileName:match("#%d%d%d%d").." </font></font>", playerName, 128, 83, 438, 45, 0x324650, 0x000000, 0, true)
        addTextArea(17, "<font face='Soopafresh,Verdana' size='30'><v>"..removeTag(profileName).."</v> <font size='-5'><g>"..profileName:match("#%d%d%d%d").." </g></font></font>", playerName, 126, 80, 438, 45, 0x324650, 0x000000, 0, true)
        putInClearQueue({16, 17}, "area", playerName)
    else
...
function stats(playerName, creatorName)
    ...
    body = body.."<textformat tabstops='0,220' font='Verdana'>Title: <V>«Speedy»</V>\tLevel: <v>28</v> <bl><font size='10'>(220/300)</font></bl>\n\n"
    body = body..translate(playerName, "firsts")..": <bl>"..playerStats[playerName].mapsFinishedFirst.."</bl>\t"..translate(playerName, "graffitiUses")..": <bl>"..playerStats[playerName].graffitiSprays.."</bl>\n"
    body = body..translate(playerName, "finishedMaps")..": <bl>"..playerStats[playerName].mapsFinished.."</bl>\t"..translate(playerName, "playtime")..": <bl>"..math.floor(seconds/3600).."h "..math.floor(seconds%3600/60).."m "..(seconds%3600%60).."s</bl>\n"
    local firstrate = "0%"
    ...
    body = body..translate(playerName, "firstRate")..": <bl>"..firstrate.."</bl>\t"..translate(playerName, "holeEnters")..": <bl>"..playerStats[playerName].timesEnteredInHole.."</bl>\n"
    body = body.."\t"..translate(playerName, "hardcoreMaps")..": <bl>"..playerStats[playerName].hardcoreMaps.."</bl>\n"
    body = body..translate(playerName, "dashUses")..": <bl>"..playerStats[playerName].timesDashed.."</bl>\n"
    body = body..translate(playerName, "timesDoubleJumped")..": <bl>"..playerStats[playerName].doubleJumps.."</bl>\n"
    body = body..translate(playerName, "rewindUses")..": <bl>"..playerStats[playerName].timesRewinded.."</bl></textformat>"
