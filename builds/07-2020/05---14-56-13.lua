...
function stats(playerName, creatorName)
    ...
    addTextArea(122, "<p align='center'><font face='"..shop.graffitiFonts[playerStats[playerName].equipment[4]].imgId.."' size='16' color='"..shop.graffitiCol[playerStats[playerName].equipment[2]].imgId.."'>"..string.gsub(playerName, "#%d%d%d%d", "").."</font></p>", creatorName, graffitiTextX, graffitiTextY, 230, 50, 0x324650, 0x000000, 0, true)
