...
function generateProfileImgs(playerName)
    local graffitiTextX, graffitiTextY = 565, 275
    addTextArea(120, "", creatorName, 565, 136, 80, 80, 0x264E57, 0x264E57, 1, true)
    addTextArea(121, "", creatorName, 565, 247, 80, 80, 0x264E57, 0x264E57, 1, true)
    addTextArea(122, "<p align='center'><font face='"..shop.graffitiFonts[playerStats[playerName].equipment[4]].imgId.."' size='16' color='"..shop.graffitiCol[playerStats[playerName].equipment[2]].imgId.."'>"..string.gsub(playerName, "#%d%d%d%d", "").."</font></p>", creatorName, graffitiTextX, graffitiTextY, 80, 50, 0x324650, 0x000000, 0, true)
    putInClearQueue({120, 121, 122}, "area", creatorName)
end
...
function lateUI(playerName)
    ...
    elseif string.sub(page, 1, 7) == "profile" then
        generateProfileImgs(playerName)
    end
end
