...
if string.find(tfm.get.room.name, "^[a-z][a-z2]%-#ninja%d+trade%d*$") or string.find(tfm.get.room.name, "^%*?#ninja%d+trade%d*$") then
    ...
    function eventNewPlayer(playerName)
        ...
        ui.addTextArea(30, "", playerName, 199, 79, 402, 242, 0x1C3A3E, 0xEFCE8F, 1, false)
        ...
        for _, letter in next, {"A", "B", "C", "D", "E", "F"} do
            ...
            buttons = buttons.."\n\n   "
            if letter == "C" then 
                ui.addTextArea(31, buttons:sub(0, 2000), playerName, 200, 80, 400, 120, 0x1C3A3E, 0xEFCE8F, 0, false) 
                buttons = "<p='align'><font face='Lucida Console' size='15'>   "
            end
        end

        ui.addTextArea(32, buttons:sub(0, 2000), playerName, 200, 200, 400, 120, 0x1C3A3E, 0xEFCE8F, 0, false)
        ui.addTextArea(33, "<p align='center'>Selected: <R>none</R></p>", playerName, 200, 80, 400, 16, 0x1C3A3E, 0x1C3A3E, 0, false)
        
        ui.addTextArea(9, "", playerName, -1, 49, 202, 302, 0xEFCE8F, 0xEFCE8F, 1, false)
        ui.addTextArea(10, "<p align='center'><font size='20' face='Soopafresh,Verdana'>Buying <a href='event:B'><VP>+</VP></a></font></p>\n<textformat tabstops='0, 50'><V>Price\tName</textformat></V>", playerName,   0, 50, 200, 300, 0x1C3A3E, 0x1C3A3E, 1, false)
        ui.addTextArea(11, "", playerName,   5, 110, 190, 235, 0x203F43, 0x203F43, 1, false)
        
        ui.addTextArea(19, "", playerName, 599, 49, 202, 302, 0xEFCE8F, 0xEFCE8F, 1, false)
        ui.addTextArea(20, "<p align='center'><font size='20' face='Soopafresh,Verdana'>Selling <a href='event:S'><VP>+</VP></a></font></p>\n<textformat tabstops='0, 50'><V>Price\tName</textformat></V>", playerName, 600, 50, 200, 300, 0x1C3A3E, 0x1C3A3E, 1, false)
        ui.addTextArea(21, "", playerName, 605, 110, 190, 235, 0x203F43, 0x203F43, 1, false)
    ...
    function eventTextAreaCallback(id, playerName, event)
        ...
        if id == 11 or id == 21 and playerName ~= event then
    ...
    function updateRelic(playerName, type)
        ...
        if trades[type]['b'][playerName] then
            ui.updateTextArea(10, "<p align='center'><font size='20' face='Soopafresh,Verdana'>Buying "..type.." <a href='event:B'><R>-</R></a></font></p>\n<textformat tabstops='0, 50'><V>Price\tName</textformat></V>", playerName)
        else 
            ui.updateTextArea(10, "<p align='center'><font size='20' face='Soopafresh,Verdana'>Buying "..type.." <a href='event:B'><VP>+</VP></a></font></p>\n<textformat tabstops='0, 50'><V>Price\tName</textformat></V>", playerName)
        end

        if trades[type]['s'][playerName] then
            ui.updateTextArea(20, "<p align='center'><font size='20' face='Soopafresh,Verdana'>Selling "..type.." <a href='event:B'><R>-</R></a></font></p>\n<textformat tabstops='0, 50'><V>Price\tName</textformat></V>", playerName)
        else 
            ui.updateTextArea(20, "<p align='center'><font size='20' face='Soopafresh,Verdana'>Selling "..type.." <a href='event:B'><VP>+</VP></a></font></p>\n<textformat tabstops='0, 50'><V>Price\tName</textformat></V>", playerName)
        end
