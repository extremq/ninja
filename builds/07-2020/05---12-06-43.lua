...
function windowConfig(title, body, playerName, pageId)
    ...
    if pageId:find("profile") ~= nil then
        ...
        addTextArea(16, "<font face='Soopafresh' size='30' color='#000000'>"..profileName.."</font>", playerName, 128, 83, 438, 45, 0x324650, 0x000000, 0, true)
        addTextArea(17, "<font face='Soopafresh' size='30'><v>"..removeTag(profileName).."</v> <g>"..profileName:match("#%d%d%d%d").."</g></font>", playerName, 126, 80, 438, 45, 0x324650, 0x000000, 0, true)
