...
translations.en = {
    ...
    enoughPlayers = "<CH>[•] There are %s players in this room and all stats are counted!</CH>",
    notEnoughPlayers = "<CH>[•] More players are needed for some stats to count. [%s/3]</CH>",
    statsCount = "<CH>[•] All stats are now counted!</CH>",
    statsDontCount = "<CH>[•] Some stats are not counted anymore!</CH>",
...
shop = {
    dashAcc = {
        shopListing({3}, "1730a4d8616.png", "particleDef", {"free", nil}, nil),
...
function generatedashAccImgsText(playerName, pageNumber)
    ...
    for i = 1, 5 do
        ...
        elseif currentShopItem.fnc(playerName) == false then
            imgs[playerName]["dashAcc"..i] = addImage(HIDDEN_DASH, "&"..i, imgBgX - 50, y[i] - 50, playerName), "img", playerName)
            putInClearQueue(addImage(LOCK, "&"..i, imgBgX + statusOffset, y[i] + statusOffset, playerName), "img", playerName)
            ...
            imgs[playerName]["dashAcc"..i] = putInClearQueue(addImage(currentShopItem.imgId, "&"..i, imgBgX- 50, y[i]- 50, playerName), "img", playerName)
