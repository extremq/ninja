...
--\t"..translate(playerName, "playtime")..": <V>"..math.floor(seconds/3600).."h "..math.floor(seconds%3600/60).."m "..(seconds%3600%60).."s</V>
    body = body.."<textformat tabstops='0,240' font='Verdana'>Title: <V>«Speedy»</V>\tLevel: <v>28</v> <bl><font size='10'>(220/300)</font></bl>\n\n"
    body = body..translate(playerName, "firsts")..": <v>"..playerStats[playerName].mapsFinishedFirst.."</v>\t"..translate(playerName, "graffitiUses")..": <v>"..playerStats[playerName].graffitiSprays.."</v>\n"
