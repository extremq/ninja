...
local TT_SCHEMA = {
    db2.UnsignedInt{ key="sz1", size=1 },
    db2.UnsignedInt{ key="sz3", size=3 },
    db2.UnsignedInt{ key="sz4", size=4 },
}

local enc = db2.encode(TT_SCHEMA, {
    sz1 = 128,
    sz3 = 16777216,
    sz4 = 4294967296,
})

local dec = db2.decode(TT_SCHEMA, enc)

print(dec.sz1, dec.sz3, dec.sz4)
