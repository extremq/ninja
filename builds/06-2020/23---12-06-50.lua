...
function openPage(title, body, playerName, pageId)
    ...
    -- Header and closebtn
    ui.addTextArea(4, "<p align='center'><j><font size='16' face='tahoma' color='#F6CF34'><b>"..title.."</b></font></p>", playerName, 318, 37, 163, 26, 0x324650, 0x000000, 0, true)
    ui.addTextArea(5, "<a href='event:CloseMenu'>\n</a>", playerName, 578, 50, 20, 20, 0x324650, 0x000000, 0, true) 
end
...
function lateUI(playerName)
    local page = playerVars[playerName].menuPage
    imgs[playerName].header = tfm.exec.addImage(SMALL_HEADER, "&1", 316, 31, playerName)
    imgs[playerName].closeBtn = tfm.exec.addImage(CLOSE_BTN, "&2", 577, 51, playerName)
