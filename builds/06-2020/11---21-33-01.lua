...
-- PLAYER COLOR SETTER
eventPlayerRespawn = secureEvent(function(playerName)
    local ostime = os.time()
...
eventPlayerDiedeventPlayerWon = secureEvent(function(playerName)
    local id = playerId(playerName)
...
-- PLAYER WIN
eventPlayerWon = secureEvent(function(playerName, timeElapsed, timeElapsedSinceRespawn)
    local id = playerId(playerName)
