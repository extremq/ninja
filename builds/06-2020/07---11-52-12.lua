...
shop = {
    dashAcc = {
        shopListing(3, "1728b45b3eb.png", "This is the default particle."),
        shopListing({3, 31}, "1728b44464b.png", "Add some hearts to your dash!"),
        shopListing({3, 13}, "1728b442708.png", "Sleek. Just like you.")
    },
    graffitiCol = {
...
function pageOperation(title, body, playerName, pageId)
    ...
    local spaceLength = 43 - #translations[playerVars[id].playerLanguage].Xbtn - #title
    local padding = ""
    for i = 1, spaceLength do 
        padding = padding.." "
    end
    local pageTitle = "<font size='15' face='Lucida Console'>"..title.."<textformat>"..padding.."</textformat>"..closebtn.."</font>\n"
    local pageBody = body
...
function createPage(title, body, playerName, pageId)
    ui.addTextArea(13, pageOperation(title, body, playerName, pageId), playerName, 200, 50, 400, 300, 0x241f13, 0xbfa26d, 1, true)
end
