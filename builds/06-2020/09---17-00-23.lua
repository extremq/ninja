...
function stats(playerName, creatorName)
    ...
    return "<font face='Lucida ConsoVerdana"..body.."</font>"
end
...
function remakeOptions(playerName)
    ...
    return "\n<font face='Lucida ConsoVerdana"..body.."</font>"
end
...
function eventTextAreaCallback(textAreaId, playerName, eventName)
    ...
    if textAreaId == 12 then
        ...
        if eventName == "LeaderOpen" then
            openPage(translations[playerVars[playerName].playerLanguage].leaderboardsTitle, "\n<font face='Lucida ConsoVerdana"..translations[playerVars[playerName].playerLanguage].leaderboardsNotice.."</font>", playerName, "leaderboards")
        end
