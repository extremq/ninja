...
function showStats()
    ...
    if bestPlayers[1][1] ~= "N/A" then
        checkUnlock(playerName, "dashAcc", 3, "particleUnlock")
...
function generateShopWelcome(playerName)
    local body = "\n\n\n\n<font face='Lucida Console' size='16'><p align='center'><CS>Your loadout!</CS></p>\n\n\n\n\n\n\n<textformat>       <textformat><a href='event:ChangePart'>["..translate(playerName, "change").."]</a><textformat>         <textformat><a href='event:ChangeGraffiti'>["..translate(playerName, "change").."]</a></font>\n\n\n"
    return body
end

function generateGraffitiWelcome(playerName)
    local body = "\n\n\n\n<font face='Lucida Console' size='16'><p align='center'><CS>Your graffiti!</CS></p>\n\n\n\n\n\n\n<textformat>       <textformat><a href='event:GraffitiChangeColor'>["..translate(playerName, "change").."]</a><textformat>         <textformat><a href='event:GraffitiChangeFont'>["..translate(playerName, "change").."]</a></font>\n\n\n"
end

--TextAreaIds = 50, 51, 52
function generateShopPage(playerName, pageNumber)
    local body = "<font face='Lucida Console' size='16'>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<p align='center'><a href='event:PrevPage'>&lt;</a> "..pageNumber.." / "..maxShopPages(shop.dashAcc).." <a href='event:NextPage'>&gt;\n</a></p>"
    return body
end
