...
function openPage(title, body, playerName, pageId)
    addTextArea(13, pageOperation(title, body, playerName, pageId), playerName, 200, 62, 400, 300, 0x1A353A, 0x7B5A35, 1, true)
    
    lateUI(playerName)

    -- Header and closebtn
    ui.addTextArea(14, "<p align='center'><j><font size='16' face='tahoma' color='#F6CF34'><b>"..title.."</b></font></p>", playerName, 318, 37, 163, 26, 0x324650, 0x000000, 0, true)
    ui.addTextArea(15, "<a href='event:CloseMenu'>\n</a>", playerName, 578, 50, 20, 20, 0x324650, 0x000000, 0, true) 
end
...
function lateUI(playerName)
    local page = playerVars[playerName].menuPage
    imgs[playerName].header = addImage(SMALL_HEADER, ":2", 316, 30, playerName)
    imgs[playerName].closeBtn = addImage(CLOSE_BTN, ":3", 577, 51, playerName)
    ...
    elseif string.find(page, "dashAcc") then
        addTextArea(20, "<p align='center'><a href='event:PrevPage'>&lt;</a> "..pageNumber.."/"..maxShopPages(#shop[dashAcc]).." <a href='event:NextPage'>&gt;</a>", playerName, 367, 357, 66, 17, 0x1A353A, 0x7b5a35, 1, true)
    ...
    elseif string.find(page, "graffitiCol") then 
        addTextArea(20, "<p align='center'><a href='event:PrevPage'>&lt;</a> "..pageNumber.."/"..maxShopPages(#shop[graffitiCol]).." <a href='event:NextPage'>&gt;</a>", playerName, 367, 357, 66, 17, 0x1A353A, 0x7b5a35, 1, true)
        generateGraffitiShopText(playerName, tonumber(string.match(page, "%d+")), "graffitiCol")
    elseif string.find(page, "graffitiFonts") then
        addTextArea(20, "<p align='center'><a href='event:PrevPage'>&lt;</a> "..pageNumber.."/"..maxShopPages(#shop[graffitiFonts]).." <a href='event:NextPage'>&gt;</a>", playerName, 367, 357, 66, 17, 0x1A353A, 0x7b5a35, 1, true)
