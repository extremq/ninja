...
function lateUI(playerName)
    ...
    elseif string.find(page, "dashAcc") then
        addTextArea(20, "<p align='center'><a href='event:PrevPage'>&lt;</a> "..pageNumber.."/"..maxShopPages(#shop[dash]).." <a href='event:NextPage'>&gt;</a>", playerName, 367, 357, 66, 17, 0x1A353A, 0x7b5a35, 1, true)
