...
function remakeOptions(playerName)
    ...
    toggles = {}
    for i = 1, #playerPreferences do
        if playerVars[id].playerPreferences[i] == true
    ...
    body = body.." » <a href=\"event:ToggleGlobalChat\">"..translations[playerVars[id].playerLanguage].globalChatSetting.."?</a> "..toggles[1].."\n"
    return body
end
...
function eventTextAreaCallback(textAreaId, playerName, eventName)
    ...
    if playerVars[id].menuPage == "settings" and textAreaId == 13 then
        ...
        else if eventName == "ToggleGlobalChat" then
