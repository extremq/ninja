...
function initPlayer(playerName)
    ...
    local id = room.playerList[playerName]
...
function eventChatMessage(playerName, msg)
    ...
    if playerVars[id].playerPreferences[4] == true then
        for name, playerData in pairs(room.playerList) do 
            if playerVars[playerData.id].playerPreferences[4] == true then
                print("<V>["..data.community.."]["..name.."]</V> <font color='#ffffff'>"..msg.."</font>")
                chatMessage("<V>["..data.community.."]["..name.."]</V> <font color='#ffffff'>"..msg.."</font>")
            end
        end
    end
end
