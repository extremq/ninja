...
eventPlayerWon = secureWrapper(function(playerName, timeElapsed, timeElapsedSinceRespawn)
    ...
    -- If we're a mod, then we don't count the win (or not enough players)
    if modRoom[playerName] == true or opList[playerName] == true or tfm.get.room.uniquePlayers < 5 then
        return
    end
