...
function generatedashAccImgsText(playerName, pageNumber)
    ...
    for i = 1, 5 do
        ...
        if currentShopItem == nil then
            imgs[playerName]["dashAcc"..sortedOrder[(pageNumber - 1) * 5 + i]] = addImage(BLOCKED_DASH, "&"..i, imgBgX - 50, y[i] - 50, playerName)
        ...
        elseif currentShopItem.fnc(playerName) == false then
            imgs[playerName]["dashAcc"..sortedOrder[(pageNumber - 1) * 5 + i]] = addImage(HIDDEN_DASH, "&"..i, imgBgX - 50, y[i] - 50, playerName)
            ...
            imgs[playerName]["dashAcc"..sortedOrder[(pageNumber - 1) * 5 + i]] = addImage(currentShopItem.imgId, "&"..i, imgBgX- 50, y[i]- 50, playerName)
        ...
        addTextArea(ids[i] + 10, "", playerName, imgBgX, y[i] - 3, 40, 40, 0x264E57, 0x264E57, 1, true)
    end
end
