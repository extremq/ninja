...
function generateShopWelcome(playerName)
    wordLength = #string.utf8(translate(playerName, "change"))

    local body = "\n\n\n\n<font face='Lucida Console' size='16'><p align='center'><CS>"..translate(playerName, "yourLoadout").."</CS></p>\n\n\n\n\n\n\n<p align='center'><a href='event:ChangePart'>["..translate(playerName, "change").."]</a><textformat>         <textformat><a href='event:ChangeGraffiti'>["..translate(playerName, "change").."]</a></p></font>\n\n\n"
    return body
end
