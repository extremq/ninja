...
translations.lv = {
    ...
    finishMapsFirst = "Pabeidz %1 mapes pirmais.",
    dashTimes = "Lieto paātrinājumu %1 reizes.",
    finishHardcoreMap = "Pabeidz %1 „Hardcore” mapes.",
    sprayGraffiti = "Lieto paātrinājumu %1 reizes.",
    rewindTimes = "Lieto attīšanu %1 reizes.",
