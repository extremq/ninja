...
-- Standard maps
stMapCodes = {{"@7725753", 3}, {"@7726015", 1}, {"@7726744", 2}, {"@7728063", 4}, {"@7731641", 2}, {"@7730637", 3}, {"@7732486", 2}, {"@6784223", 3}}
stMapsLeft = {{"@7725753", 3}, {"@7726015", 1}, {"@7726744", 2}, {"@7728063", 4}, {"@7731641", 2}, {"@7730637", 3}, {"@7732486", 2}, {"@6784223", 3}}
...
function showJumpParticles(types, x, y)
    ...
    for name, data in pairs(room.playerList) do
        if room.playerList[name].id ~= 0 and playerVars[room.playerList[name].id].playerPreferences[2] == true then
            for i = 1, #types do
                displayParticle(types[i], x, y, random(), -random()*4, 0, 0, name)
                displayParticle(types[i], x, y, -random(), -random()*3, 0, 0, name)
