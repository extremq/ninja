...
function generateShopPartImgsText(playerName, pageNumber)
    ...
    for i = 1, 3 do
        ...
        elseif shop.dashAcc[(pageNumber - 1) * 3 + i].fnc(playerName) == false
            ...
            local selectState = "<a href='event:Select"..i.."'>[Select]</a>"
...
function eventTextAreaCallback(textAreaId, playerName, eventName)
    ...
    elseif string.find(currentPage, "shopPart") then
        ...
        local nmbr = string.match(currentPage, "%d+")
        if eventName == "NextPage" and tonumber(nmbr) + 1 <= maxPages then
            openPage(translate(playerName, "shopTitle"), generateShopPage(playerName, tonumber(nmbr) + 1), playerName, "shopPart#"..(tonumber(nmbr) + 1))
