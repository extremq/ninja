...
function generateGraffitiImages(playerName)
    local colorX, colorY = 260, 150
    local fontX, fontY = 440, 150

    imgs[playerName].graffitiColor = addImage(COLOR_IMG, "&2", dashX, dashY, playerName)
    imgs[playerName].graffitiFont = addImage(FONTS_IMG, "&3", dashX, dashY, playerName)
end
...
function generateShopPage(playerName, pageNumber, type)
    local body = "<font face='Lucida Console' size='16'>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<p align='center'><a href='event:PrevPage'>&lt;</a> "..pageNumber.." / "..maxShopPages(shop[type]).." <a href='event:NextPage'>&gt;\n</a></p>"
    return body
end

function generateShopImgs(playerName)
    local id = playerId(playerName)
    local COLO, dashY = 260, 150
