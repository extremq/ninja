...
function stats(playerName, playerId, creatorId)
    ...
    body = body.." » "..translations[playerVars[cre.playerLanguageatorId]].firsts..": <modRoom>"..playerStats[playerId].mapsFinishedFirst.."</modRoom>\n"
    body = body.." » "..translations[playerVars[cre.playerLanguageatorId]].finishedMaps..": <modRoom>"..playerStats[playerId].mapsFinished.."</modRoom>\n"
    local firstrate = "0%"
    ...
    body = body.." » "..translations[playerVars[cre.playerLanguageatorId]].firstRate..": <modRoom>"..firstrate.."</modRoom>\n"
    body = body.." » "..translations[playerVars[cre.playerLanguageatorId]].holeEnters..": <modRoom>"..playerStats[playerId].timesEnteredInHole.."</modRoom>\n"
    body = body.." » "..translations[playerVars[cre.playerLanguageatorId]].graffitiUses..": <modRoom>"..playerStats[playerId].graffitiSprays.."</modRoom>\n"
    body = body.." » "..translations[playerVars[cre.playerLanguageatorId]].dashUses..": <modRoom>"..playerStats[playerId].timesDashed.."</modRoom>\n"
    body = body.." » "..translations[playerVars[cre.playerLanguageatorId]].rewindUses..": <modRoom>"..playerStats[playerId].timesRewinded.."</modRoom>\n"
