...
translations.fr = {
    ...
    graffitiSetting = "Activer les graffiti",
...
-- Standard maps
stMapCodes = {{"@7725753", 3}, {"@7726015", 1}, {"@7726744", 2}, {"@7728063", 4}, {"@7731641", 2}, {"@7730637", 3}, {"@7732486", 2}, {"@6784223", 4}}
stMapsLeft = {{"@7725753", 3}, {"@7726015", 1}, {"@7726744", 2}, {"@7728063", 4}, {"@7731641", 2}, {"@7730637", 3}, {"@7732486", 2}, {"@6784223", 4}}
    ...
    if room.playerList[playerName].isDead == false then
        ...
        if (keyCode == 0 or keyCode == 2) and ostime - cooldowns[id].lastDashTime > DASHCOOLDOWN then
            ...
            if dashUsed == true then
                ...
                showDashParticles({3, 31}, direction, xPlayerPosition, yPlayerPosition)
            end
        --[[
        ...
        elseif keyCode == 1 and ostime - cooldowns[id].lastJumpPressTime < 200 and ostime - cooldowns[id].lastJumpTime > JUMPCOOLDOWN  then
            ...
            showJumpParticles({3, 31}, xPlayerPosition, yPlayerPosition)
        --[[
...
function createPage(title, body, playerName, pageId)
    ui.addTextArea(13, pageOperation(title, body, playerName, pageId), playerName, 202, 50, 405, 300, 0x241f13, 0xbfa26d, 1, true)
end
...
function stats(playerName, playerId, creatorId)
    ...
    local secondsPlayed = math.floor((os.time() - playerStats[playerId].playtime) / 1000)

    body = body.." » "..translations[playerVars[creatorId].playerLanguage].playtime..": <R>"..(seconds/3600).."</R>h <R>"..(seconds%3600/60).."</R>m <R>"..(seconds%3600%60).."</R>s\n"
