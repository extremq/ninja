...
function eventTextAreaCallback(textAreaId, playerName, eventName)
    ...
    if textAreaId == 12 then
        ...
        if eventName == "LeaderOpen" then
            openPage(translations[playerVars[playerName].playerLanguage].leaderboardsTitle, "<font size='12'>"..translations[playerVars[playerName].playerLanguage].leaderboardsNotice.."</font>", playerName, "leaderboards")
        end
        ...
        if eventName == "AboutOpen" then
            openPage(translations[playerVars[playerName].playerLanguage].aboutTitle, "<font size='12'>"..translations[playerVars[playerName].playerLanguage].aboutBody.."\n\n\n\n\n\n<p align='right'><G>version: "..VERSION.."</G></p></font>", playerName, "about")
        end
    end
