...
function clear(playerName)
    ...
    elseif string.find(page, "shopPart") do
...
function generateShopPage(playerName, pageNumber)
    local body = "<font face='Lucida Console' size='16'>Collection\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<p align='center'><a href='event:PrevPage'>............◀</a> 1 / 5 <a href='event:NextPage'>▶............</a></p>"
...
function eventTextAreaCallback(textAreaId, playerName, eventName)
    ...
    elseif currentPage == "shop" do
        if eventName == "ChangePart" do
