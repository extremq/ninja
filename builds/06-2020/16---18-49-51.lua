...
shop = {
    ...
    graffitiCol = {
        ...
        shopListing('#8c0404', '#8c0404', "Where's this... blood from?", "Dash 100 times.", {"timesDashed", 1})
    },
    graffitiImgs = {
    ...
    graffitiFonts = {
        ...
        shopListing("Century Gothic", "Century Gothic", "Wow, you're so modern.", "Dash 50 times.", {"timesDashed", 1})
    }
}
...
function showDashParticles(playerName, types, direction, x, y)
    ...
    for name, data in pairs(room.playerList) do
        if playerVars[name].playerPreferences[2] == true and playerName ~= name then
            for i = 1, #types do
